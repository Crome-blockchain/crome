...
/** Utility functions used by the Crome Qt UI.
 */
namespace GUIUtil
{
...
// Render CROM addresses in monospace font
...
// Parse "crome:" URI into recipient object, return true on successful parsing
