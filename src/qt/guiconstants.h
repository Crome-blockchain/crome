...
/* Crome GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Crome"
#define QAPP_ORG_DOMAIN "crome.org"
#define QAPP_APP_NAME_DEFAULT "Crome-Qt"
#define QAPP_APP_NAME_TESTNET "Crome-Qt-testnet"
