...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CROM features */
        {"crome", "listmasternodes", &listmasternodes, true },
        {"crome", "getmasternodecount", &getmasternodecount, true },
        {"crome", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"crome", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"crome", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"crome", "masternodecurrent", &masternodecurrent, true },
        {"crome", "startmasternode", &startmasternode, true },
        {"crome", "createmasternodekey", &createmasternodekey, true },
        {"crome", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"crome", "listmasternodeconf", &listmasternodeconf, true },
        {"crome", "getmasternodestatus", &getmasternodestatus, true },
        {"crome", "getmasternodewinners", &getmasternodewinners, true },
        {"crome", "getmasternodescores", &getmasternodescores, true },
        {"crome", "preparebudget", &preparebudget, true },
        {"crome", "submitbudget", &submitbudget, true },
        {"crome", "mnbudgetvote", &mnbudgetvote, true },
        {"crome", "getbudgetvotes", &getbudgetvotes, true },
        {"crome", "getnextsuperblock", &getnextsuperblock, true },
        {"crome", "getbudgetprojection", &getbudgetprojection, true },
        {"crome", "getbudgetinfo", &getbudgetinfo, true },
        {"crome", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"crome", "mnfinalbudget", &mnfinalbudget, true },
        {"crome", "checkbudgets", &checkbudgets, true },
        {"crome", "mnsync", &mnsync, true },
        {"crome", "spork", &spork, true },
...
{
    return "> crome-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:56201/\n";
}
