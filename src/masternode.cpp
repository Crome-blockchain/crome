...
{
    if (nHeight > 1200000) return 950000 * COIN;
    if (nHeight > 1100000) return 950000 * COIN;
    if (nHeight > 1000000) return 950000 * COIN;
    if (nHeight >  950000) return 950000 * COIN;
    if (nHeight >  900500) return 950000 * COIN;
    if (nHeight >  900000) return 950000 * COIN;
    if (nHeight >  800000) return 650000 * COIN;
    if (nHeight >  700500) return 650000 * COIN;
    if (nHeight >  700000) return 650000 * COIN;
    if (nHeight >  600500) return 550000 * COIN;
...
{
    if (nHeight > 1200000) return 4000 * COIN;
    if (nHeight > 1100000) return 5500 * COIN;
    if (nHeight > 1000000) return 6000 * COIN;
    if (nHeight >  950000) return 6500 * COIN;
    if (nHeight >  900500) return 8000 * COIN;
    if (nHeight >  900000) return 0.00 * COIN;
    if (nHeight >  800000) return 5500 * COIN;
    if (nHeight >  700500) return 5000 * COIN;
    if (nHeight >  700000) return 0.00 * COIN;
    if (nHeight >  600500) return 4500 * COIN;
    if (nHeight >  600000) return 0.00 * COIN;
...
{
    if (nHeight > 1200000) return 3300 * COIN;
    if (nHeight > 1100000) return 4800 * COIN;
    if (nHeight > 1000000) return 5300 * COIN;
    if (nHeight >  950000) return 5800 * COIN;
    if (nHeight >  900500) return 7300 * COIN;
    if (nHeight >  900000) return 0.00 * COIN;
    if (nHeight >  800000) return 4900 * COIN;
    if (nHeight >  700500) return 4400 * COIN;
    if (nHeight >  700000) return 0.00 * COIN;
    if (nHeight >  600500) return 3900 * COIN;
    if (nHeight >  600000) return 0.00 * COIN;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 CROM tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = UINT256_ZERO;
    CTransaction tx2;
    GetTransaction(vin.prevout.hash, tx2, hashBlock, true);
    BlockMap::iterator mi = mapBlockIndex.find(hashBlock);
    if (mi != mapBlockIndex.end() && (*mi).second) {
        CBlockIndex* pMNIndex = (*mi).second;                                                        // block for 1000 CROM tx -> 1 confirmation
