...
{
    const char* pszTimestamp = "NASA's brand new $10 billion telescope hit by space rock, Jun 10 2022";
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256S("00000df2de018c74c9de1d60009b9b6b8342694b67dce9ed0f41a90a41935196"))
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1654895999, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1654895999, 255912, 0x1e0ffff0, 1, 0.00000050 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000df2de018c74c9de1d60009b9b6b8342694b67dce9ed0f41a90a41935196"));
        ...
        consensus.nMaxMoneyOut = 400000000 * COIN;
        ...
        // spork keys
        consensus.strSporkPubKey = "04f84add8ae1952b6e9935eb69fff56660f23c8abd7d941d3ae7286007b40293a49203426ccc8bb465f4acf53b70e6ede48022c8d13267f1928985fbf5a0706d64";
        consensus.strSporkPubKeyOld = "";
        consensus.nTime_EnforceNewSporkKey = 0;
        consensus.nTime_RejectOldSporkKey = 0;

        // dev address
        consensus.devAddress = "HXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";

        // burn addresses
        consensus.mBurnAddresses = {
           { "HXXXXXXXXXXXXXXXXXXXXXXXXXXXVtkn93", 0 }
        };
        ...
        vSeeds.push_back(CDNSSeedData("149.28.125.127", "149.28.125.127 "));
	    vSeeds.push_back(CDNSSeedData("149.28.122.238", "149.28.122.238"));
        vSeeds.push_back(CDNSSeedData("137.220.62.185", "137.220.62.185"));
        vSeeds.push_back(CDNSSeedData("216.128.148.196", "216.128.148.196"));
        ...
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x00)(0x03)(0x59).convert_to_container<std::vector<unsigned char> >();
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // crome starting difficulty is 1 / 2^12
        ...
        vSeeds.push_back(CDNSSeedData("tseeder", "tseeder.cromechain.com"));
	    vSeeds.push_back(CDNSSeedData("tseed1", "tseed1.cromechain.com"));
        vSeeds.push_back(CDNSSeedData("tseed2", "tseed2.cromechain.com"));
        vSeeds.push_back(CDNSSeedData("tseed3", "tseed3.cromechain.com"));
        vSeeds.push_back(CDNSSeedData("tseed4", "tseed4.cromechain.com"));
	    vSeeds.push_back(CDNSSeedData("tseed5", "tseed5.cromechain.com"));
	    vSeeds.push_back(CDNSSeedData("tseed6", "tseed6.cromechain.com"));
	    vSeeds.push_back(CDNSSeedData("tseed7", "tseed7.cromechain.com"));
	    vSeeds.push_back(CDNSSeedData("tseed8", "tseed8.cromechain.com"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet crome addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet crome script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet crome BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet crome BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet crome BIP44 coin type is '1' (All coin's testnet default)
