...
"""Verify that starting crome with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start crome with -? for help text")
        ...
        self.log.info("Start crome with -version for version information")
