...
# Create zip file of binaries
    cp crome/src/cromed crome/src/crome-cli crome/src/crome-tx crome/src/qt/crome-qt crome/Crome-Core.dmg .
    zip CROM-MacOS.zip cromed crome-cli crome-tx crome-qt Crome-Core.dmg
    rm -f cromed crome-cli crome-tx crome-qt Crome-Core.dmg
