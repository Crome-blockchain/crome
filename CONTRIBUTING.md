Contributing to Crome Core
============================

The Crome Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Crome Core project, and is not to be
confused with overall Crome Network Protocol consensus changes.

Whether a pull request is merged into Crome Core rests with the project merge
...
Patches that change Crome consensus rules are considerably more involved than
...
Where a patchset proposes to change the Crome consensus, it must have been
...
The project leader is the release manager for each Crome Core release.
