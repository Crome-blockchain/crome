...
# Create zip file of binaries
	cp crome/src/cromed crome/src/crome-cli crome/src/crome-tx crome/src/qt/crome-qt .
	zip CROM-$(git describe --abbrev=0 --tags | sed s/v//)-Linux.zip cromed crome-cli crome-tx crome-qt
	rm -f cromed crome-cli crome-tx crome-qt
