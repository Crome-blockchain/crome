...
#define MyAppName "Crome Core"
#define MyAppPublisher "2022 Crome Core Developers"
#define MyAppURL "https://cromechain.com"
#define MyAppExeName "crome-qt.exe"
#define MyAppExtraData "https://explorer.cromechain.com/bootstraps/CROM/bootstrap.zip"
...
[Files]
Source: ".\package\crome-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Crome\Crome-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Crome\Crome-Qt,strDataDir|{userappdata}\Crome\}');
  Result := True;
end;
