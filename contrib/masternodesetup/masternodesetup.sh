...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='crome.conf'
CONFIGFOLDER='/root/.crome'
COIN_DAEMON='cromed'
COIN_CLI='crome-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/Crome-blockchain/crome/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
